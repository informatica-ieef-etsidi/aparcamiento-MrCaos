...
void main() {
	...
	struct TUsuario persona1 = { "Marcos", "qwerty" };
			...
			if (plaza1.estado == 'O' && plaza2.estado == 'O' && plaza3.estado == 'O' && plaza4.estado == 'O')
				...
				case 'c':
					if (plaza1.estado == 'L') {
						...
						for (j = 4; j < 7; j++) {
							if (98 <= plaza1.matricula[j] && plaza1.matricula[j] <= 122 && plaza1.matricula[j] != 101 && plaza1.matricula[j] != 105 && plaza1.matricula[j] != 111 && plaza1.matricula[j] != 117)
								plaza1.matricula[j] = plaza1.matricula[j] - 32;
						}

						if (strcmp(plaza1.matricula, plaza2.matricula) == 0 || strcmp(plaza1.matricula, plaza3.matricula) == 0 || strcmp(plaza1.matricula, plaza4.matricula) == 0) {
						...
						for (j = 4; j < 7; j++) {
							if (98 <= plaza2.matricula[j] && plaza2.matricula[j] <= 122 && plaza2.matricula[j] != 101 && plaza2.matricula[j] != 105 && plaza2.matricula[j] != 111 && plaza2.matricula[j] != 117)
								plaza2.matricula[j] = plaza2.matricula[j] - 32;
							}

						if (strcmp(plaza2.matricula, plaza1.matricula) == 0 || strcmp(plaza2.matricula, plaza3.matricula) == 0 || strcmp(plaza2.matricula, plaza4.matricula) == 0) {
							printf("Esa matricula ya esta registrada\n");
				...
				case 'm':
					if (plaza3.estado == 'L') {
						...
						getchar();
						for (j = 4; j < 7; j++) {
							if (98 <= plaza3.matricula[j] && plaza3.matricula[j] <= 122 && plaza3.matricula[j] != 101 && plaza3.matricula[j] != 105 && plaza3.matricula[j] != 111 && plaza3.matricula[j] != 117)
								plaza3.matricula[j] = plaza3.matricula[j] - 32;
						}

						if (strcmp(plaza3.matricula, plaza1.matricula) == 0 || strcmp(plaza3.matricula, plaza2.matricula) == 0 || strcmp(plaza3.matricula, plaza4.matricula) == 0) {
							printf("Esa matricula ya esta registrada\n");
							memset(plaza3.matricula, 0, 8);
						}
							...
							for (j = 4; j < 7; j++) {
							if (98 <= plaza4.matricula[j] && plaza4.matricula[j] <= 122 && plaza4.matricula[j] != 101 && plaza4.matricula[j] != 105 && plaza4.matricula[j] != 111 && plaza4.matricula[j] != 117) 
								plaza4.matricula[j] = plaza4.matricula[j] - 32;
							}

							if (strcmp(plaza4.matricula, plaza1.matricula) == 0 || strcmp(plaza4.matricula, plaza2.matricula) == 0 || strcmp(plaza4.matricula, plaza3.matricula) == 0) {
								printf("Esa matricula ya esta registrada\n");
								memset(plaza4.matricula, 0, 8);
							}
						else {
